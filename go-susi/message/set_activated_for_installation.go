...
func Send_set_activated_for_installation(client_addr string, system *xml.Hash) {
  ...
  set_activated_for_installation := "<xml><header>set_activated_for_installation</header><set_activated_for_installation></set_activated_for_installation><source>"+ config.ServerSourceAddress +"</source><target>"+ client_addr +"</target>" + faistate + "</xml>"
